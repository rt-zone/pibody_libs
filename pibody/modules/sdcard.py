...
class SDCard:
    def __init__(self, baudrate=1320000, slot_1: str = 'G', slot_2: str = 'H', spi_id: int = 0):
        
        _slot_1 = get_pins_by_slot(slot_1)
        _slot_2 = get_pins_by_slot(slot_2)
        cs  = Pin(_slot_1[1], Pin.OUT)
        spi = SPI(
            spi_id,
            baudrate=400000,
            polarity=0,
